...
これはリマインダーです。{cfg:site_name}へのアクセスには、以下のバウチャーをご利用ください。このバウチャーを使用して、1セットのファイルをアップロードし、1グループの人がダウンロードできるようにすることができます。
...
<p>
    これはリマインダーです。<a href="{cfg:site_url}">{cfg:site_name}</a>へのアクセスには、以下のバウチャーをご利用ください。このバウチャーを使用して、1セットのファイルをアップロードし、1グループの人がダウンロードできるようにすることができます。
</p>
