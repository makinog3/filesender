...
{if:files>1}Several files{else}A file{endif} you uploaded {if:files>1}have{else}has{endif} been downloaded from {cfg:site_name} by {if:recipient.email}{recipient.email}{else}anonymous user{endif} :
